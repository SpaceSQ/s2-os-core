...
4. **Vault Permissions**: Automatically provision the `s2_memory_vault/` directory and ensure the host user has `r/w` permissions so the SQLite Holographic Memory Array can securely write to disk.
